...
Инструмент для автоматической миграции проектов Bevy Engine между версиями 0.12, 0.13, 0.15, 0.16, 0.17 и 0.18.
...
- 🔄 **Автоматическая миграция** между версиями Bevy 0.12 → 0.13 → 0.15 → 0.16 → 0.17 → 0.18
